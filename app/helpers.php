...
function roleLandingPage(){ $r=currentRole(); if($r=='department coordinator') return 'index.php?page=projects'; if($r=='reviewer') return 'index.php?page=approvals'; return 'index.php?page=dashboard'; }
