...
<h5 class="fw-bold">Project Entries</h5><p class="text-muted small">Saving this report adds 1 to each selected project's Monitoring Count. Approval status does not add extra count.</p><div class="table-responsive"><table class="table table-bordered"><thead><tr><th>Project</th><th>Proponents</th><th>Date</th><th>Location</th><th>Fund</th><th>Cost</th><th>Phase</th></tr></thead><tbody>
